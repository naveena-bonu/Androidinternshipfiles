...
public class MainActivity extends AppCompatActivity {
    ...
    //according to work manager it allots the work. it diplays diff msges as to check what is working at present
    //WorkManager manager; should not be called here as single manager takes the work
